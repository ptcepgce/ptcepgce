...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block: Type[Union[PreActBlock, BasicBlock, Bottleneck]], planes: int, blocks: int,
...
def preresnet18(
    ...
    """
    print('preresnet18')
    return _resnet('preresnet18', PreActBlock, [2, 2, 2, 2], pretrained, progress,
