...
class ncerce:
    def __init__(
        ...
        if self.args.dataset == 'cifar10':
            args.alpha, args.beta = 1.0, 1.0
        if self.args.dataset == 'cifar100':
            args.alpha, args.beta = 10.0, 0.1
   
        self.criterion = NCEandRCE(args.alpha, args.beta, num_classes=num_classes)
